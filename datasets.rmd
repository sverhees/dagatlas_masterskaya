...
* Our [library]() of descriptive sources
* Our [literature database]() with bibliographical information about the sources in the library
...
> For most sources in our archive, you can find the name and type of the idiom in [this table](https://docs.google.com/spreadsheets/d/1XmOaGjd3ri6uA6yKBNobEfRqkPnsO3ljy_DssM2JrqM/edit?usp=sharing). Alternatively, you can search for the name and type of a certain idiom in [this database](https://sverhees.github.io/master_villages/sample_maps.html). If you cannot find the idiom referenced in your source, please contact Samira.
...
> Maps are generated based on the **value** column. If you want to show the distribution of multiple parameters, please name your columns **value1**, **value2**, etc.
