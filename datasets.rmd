...
> For most sources in our archive, you can find the name and type of the idiom in [this table](https://docs.google.com/spreadsheets/d/1XmOaGjd3ri6uA6yKBNobEfRqkPnsO3ljy_DssM2JrqM/edit?usp=sharing). Alternatively, you can search for the name and type of a certain idiom in [this database](https://sverhees.github.io/master_villages/maps_new.html#dialects). If you cannot find the idiom referenced in your source, please contact Samira.
